                	...
                	<div class="row">
                    	<div class="col-lg-6">
                        	<div class="well well-lg">
                            	<img src="img/blogs/c.jpg" height="100" width="300">
                              	<h2>C/C++</h2>
                                <p class="text-muted">Vineet Strivastav | 20 mins ago</p>
                                <p>All the famous lines are reserved under the quotes of perfection. Verticalned is getting ready to be in quotes sooner.
								</p>
                                <p class="btn btn-default">12 <strong>Likes</strong> | 32 <strong>Comments</strong></p>
                                <a href="#" class="btn btn-primary pull-right">Read <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                            </div>
                        </div>
                        <div class="col-lg-6">
                        	<div class="well well-lg">
