...
?>               
                ...
                <div class="dropdown profile-element"> 
                    		 <span>
                           		<img alt="image" class="img-circle" src="<?php if(isset($user->img) && !empty($user->img)){ echo $user->img;}else{ echo "img/user.png";} ?>">
                             </span>
                             <br>
                    ...
                    <ul class="nav nav-pills nav-stacked">
                      ...
                      <li <?php if($page == "modules"){ echo 'class="active"';} ?> ><a href="modules.php">Modules</a></li>
