	...
	<div class="container">
       <div class="page-header" id="banner">
			<div class="row">
            	<div class="col-lg-7">
                <br><br>
                	<h3 class="lead">Welcome to VerticalNed, Platform which analyses your strength and weakness using our special algorithms.</h3>
                    <h4>Features : </h4>
                    <ul>
                    <li> Preparation for Competetive exams.</li>
                    <li> Get specialised knowledge about your subject</li>
                    </ul>
                </div>
                <div class="col-lg-5">
                	<br><br>
