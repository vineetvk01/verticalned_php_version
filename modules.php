       ...
       <div class="page-header" id="banner">
			<div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <hr class="intro-divider">
                    <?php
						$res = mysqli_query($db,"SELECT `tcode`, `type1`, `subtype`, `price`, `description`, `added` FROM `ques_def`");
						if(mysqli_num_rows($res) > 0){
							while($data = $res->fetch_object()){
							?>
                     <div class="well">
                      <h1><?php echo $data->type1; ?> <span style="font-size:16px;"><?php echo $data->subtype; ?> </span></h1>
                      <p class="text-muted">2016 . Hard . 10mins | Price : <?php echo $data->price; ?></p>
                      <p><?php echo $data->description; ?> </p>
                      <a href="#" class="btn btn-default">Score: 120</a>
                      <a href="test/?t=<?php echo $data->tcode; ?>" target="_bank" class="btn btn-primary pull-right">Attempt <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
                    </div>
                            <?php
						}
					}
